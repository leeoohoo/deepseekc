...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-dark-950 via-dark-900 to-dark-950 flex items-center justify-center p-4">
      <SEO
        title="Register"
        description="Create a new DeepSeek CLI account with email verification code."
      />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-dark-300">Sign up with your email and verification code</p>
        </div>
        ...
        <div className="card bg-dark-900/50 border border-dark-800 rounded-2xl backdrop-blur-xl p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <Users className="absolute left-3 top-1/2 transform -translate-y-1/2 text-dark-500 w-5 h-5" />
                <input
                  type="text"
                  value={referralCode}
                  onChange={(e) => setReferralCode(e.target.value.toUpperCase())}
                  className="w-full pl-12 pr-4 py-3 bg-dark-800/50 border border-dark-700 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-colors text-white placeholder-dark-500"
                  placeholder="Enter if you have a referral code"
                  disabled={isLoading || isSendingCode}
                />
              </div>
              <p className="text-xs text-dark-500 mt-2">
                Optional - enter if you have a referral code from a friend
              </p>
            </div>
